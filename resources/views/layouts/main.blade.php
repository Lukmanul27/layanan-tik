    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-1 order-lg-2">
          <img src="{{ 'assets_skpd/img/hero-img.svg' }}" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
        </div>
      </div>
    </div>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About</h2>
          <p>Pelayanan Teknologi Informasi dan Telekomunikasi (Tik) sangat penting dalam dunia modern yang didorong oleh teknologi. Ini membantu organisasi dan individu menghadapi tantangan teknologi, memaksimalkan potensi teknologi, dan menjaga konektivitas yang kuat dalam era digital.</p>
        </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            ...
            <p>Teknologi merujuk pada penerapan pengetahuan ilmiah dan keterampilan praktis untuk menciptakan, merancang, mengembangkan, dan menggunakan alat, mesin, perangkat lunak, sistem, serta berbagai proses yang bertujuan untuk memecahkan masalah, memenuhi kebutuhan, atau mencapai tujuan tertentu dalam berbagai bidang kehidupan. Teknologi memainkan peran yang sangat penting dalam perkembangan manusia dan masyarakat modern, mengubah cara kita bekerja, berkomunikasi, belajar, berinteraksi, dan bahkan memandang dunia.</p>
            <p>Namun, dalam perkembangan teknologi, munculnya ancaman siber menjadi isu yang mendesak. Keamanan data, perlindungan informasi pribadi, dan keamanan infrastruktur menjadi fokus utama organisasi yang beroperasi secara digital. Upaya yang tepat diperlukan untuk melindungi sistem dan data dari serangan siber yang dapat merusak reputasi dan stabilitas.</p>
          </div>
          <div class="col-lg-6">
            <div class="content ps-0 ps-lg-5">
              <p class="fst-italic">Di samping itu, transformasi teknologi juga dapat memiliki dampak pada lapangan pekerjaan tradisional. Automatisasi dan otomatisasi proses bisnis dapat menggantikan beberapa pekerjaan yang lebih rutin. Oleh karena itu, penting untuk berinvestasi dalam pelatihan dan pengembangan keterampilan yang relevan untuk menghadapi perubahan ini.
              </p>
              <ul>
